...
namespace EFCoreDemos.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(OffersContext context) // constructor di
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Remarks")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
